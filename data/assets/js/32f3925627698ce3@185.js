...
md`# A Bar Chart with an unnecessary ammount of features`
)});
  main.variable(observer()).define(["md"], function(md){return(
md `I'll have to change up a few things so that it's more idiomatic to the notebook syntax, but all the logic is still there and seems to be working fine.`
)});
  main.variable(observer()).define(["html"], function(html){return(
html`<i>You can <b>zoom</b>, <b>sort</b> and <b>filter</b> through the dataset</i>`
)});
  main.variable(observer()).define(["html"], function(html){return(
html`Choose Value
<select class="opt">
	<option value="_1">Value 1</option>
	<option value="_2">Value 2</option>
</select><br>
...
<div>
  ...
  main.variable(observer("load")).define("load", ["d3","chart","data"], function(d3,chart,data)
{
  ...
  main.variable(observer("chart")).define("chart", ["d3"], function(d3){return(
